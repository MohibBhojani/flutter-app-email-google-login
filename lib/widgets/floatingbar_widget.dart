...
class FloatingNavbar extends StatefulWidget {
  ...
  FloatingNavbar({
    ...
    this.unselectedItemColor = Colors.red,
    this.margin = const EdgeInsets.only(left: 4, top: 10, right: 4, bottom: 2),
    this.padding = const EdgeInsets.only(bottom: 11, top: 11),
